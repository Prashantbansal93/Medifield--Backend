...
async function run() {
  ...
  await ensureUser({
    ...
    profile: {
      ...
      aadhaarImageUrl: 'https://example.com/retailer-doc-1',
      shopLicenseImageUrl: 'https://example.com/retailer-doc-2',
      city: 'Jaipur',
      lat: 26.9124,
      lng: 75.7873,
    },
  ...
  for (let i = 1; i <= 20; i += 1) {
    ...
    const user = await ensureUser({
      ...
      profile: {
        ...
        aadhaarImageUrl: 'https://example.com/wh-doc-1',
        shopLicenseImageUrl: 'https://example.com/wh-doc-2',
        city: 'Jaipur',
        lat: 26.91 + i * 0.001,
        lng: 75.78 + i * 0.001,
      },
